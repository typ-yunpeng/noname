...
const translates = {
	...
	oljuxiang: "拒降",
	oljuxiang_info: "每回合限一次，你于摸牌阶段获得牌后，可以弃置这些牌，令当前回合角色本回合出【杀】次数+X（X为你以此法弃置的牌数）。",
	ol_jsrg_sunjian: "闪孙坚",
	...
	ol_xusheng: "OL界徐盛",
	ol_xusheng_prefix: "OL界",
	ol_pojun: "破军",
	ol_pojun_info: "当你使用【杀】指定目标后，你可以将其至多X张牌移出游戏直到回合结束（X为其体力值）。你使用的【杀】对手牌区与装备区内牌数皆小于等于你的角色造成的伤害+1。",
	ol_fuhuanghou: "OL界伏寿",
